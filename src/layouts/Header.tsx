...
export const Header = () => {
    ...
    return (
        <>
            <header className="hidden flex-col justify-start shadow-md min-[1200px]:flex">
                ...
                <nav className="py-3 px-20 flex justify-between items-center">
                    <a href="/">
                    ...
                    <button className="py-3 px-5 bg-[#e02454] text-white rounded-full font-semibold text-sm flex justify-center items-center gap-2"><SlCalender className="text-lg" /> Get a Quote</button>
                </nav>
            </header>
                ...
                <AnimatePresence>
                    {isOpen && (
                        <motion.div
                            ...
                            <a
                                href="/"
                                className="w-full text-[#003a66] hover:text-[#e02454] font-medium border-b-1 border-b-[#0000005d] p-4">
                                Home
                            </a>
                            <a href="/about" className="w-full text-[#003a66] hover:text-[#e02454] font-medium border-b-1 border-b-[#0000005d] p-4">
                                About
                            </a>
                            <a href="/services" className="w-full text-[#003a66] hover:text-[#e02454] font-medium border-b-1 border-b-[#0000005d] p-4">
                                Services
                            </a>
                            <a href="/contact" className="w-full text-[#003a66] hover:text-[#e02454] font-medium p-4 pb-1">
                                Contact
                            </a>
                        </motion.div>
                    )}
